...
class Game2048(Frame):
    def __init__(self):
        ...
        self.commands = {c.KEY_UP: logic2048.move_up, c.KEY_DOWN: logic2048.move_down,
                         c.KEY_LEFT: logic2048.move_left, c.KEY_RIGHT: logic2048.move_right}
        self.grid_cells = []
        self.init_grid()
        self.init_matrix()
    ...
    def init_grid(self):
        backgrounf = Frame(self, c.BACKGROUND_COLOR_GAME,
